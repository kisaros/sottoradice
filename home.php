    ...
    <header class="hero row align-items-center position-relative mb-5" style="margin-top: 80px">
        <div class="col-12 col-md-6">
            ...
            <h2 class="serif font-weight-300 text-secondary text-center text-md-left pb-4 px-4 px-md-0">Progetti
                interattivi e guide realizzati dagli studenti dell'IIS "Benedetto Radice" di Bronte. Per capire davvero
                la matematica.</h2>
            <div class="d-flex align-item-center justify-content-start">
                ...
                <a href="/chi-siamo.php" title="Chi siamo | Sottoradice" class="btn btn-outline-success rounded-lg">Chi
                    siamo</a>
            </div>
        </div>
