...
$title = "La tombola matematica | Sottoradice";
$desc = "Il gioco della tombola reinventato: ogni numero nasconde un quesito. Esercitazione interattiva.";
$ogImage = $dominio . "assets/images/sottoradice_scomporre_per_comprendere.png";
$keywords = "Sottoradice, Bronte, matematica, progetti interattivi, wizard, giochi matematici, tombola matematica";
        ...
        <div class="container pt-5" style="padding-left: 0 !important; padding-right: 0 !important;">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-md-between">
                <div class="mr-0 mr-md-5 mb-5 mb-md-0">
                    ...
                    <p>
                        La tombola matematica sarà presto online.
                    </p>
                </div>
                <figure class="">
