...
$title = "Super Mario e i vettori | Sottoradice";
$desc = "Geometria piana attraverso Super Mario e i vettori. Esercitazione interattiva.";
$ogImage = $dominio . "assets/images/sottoradice_scomporre_per_comprendere.png";
$keywords = "Sottoradice, Bronte, matematica, progetti interattivi, wizard, giochi matematici, piano cartesiano, super mario, vettori";
        ...
        <div class="container pt-5" style="padding-left: 0 !important; padding-right: 0 !important;">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-md-between">
                <div class="mr-0 mr-md-5 mb-5 mb-md-0">
                    ...
                    <p>
                        Super Mario e i vettori sarà presto online.
                    </p>
                </div>
                <figure class="">
